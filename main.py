...
with open("comments.json", mode="r", encoding="utf8") as comments:
    ...
    for comment_dict in data:
        ...
        while answered is False:
            ...
            if fake_or_real == "save":
                answered = True
            elif (fake_or_real != "y") and (fake_or_real != "n"):
                answered = False
            else:
                answered = True
        ...
        # save_files()
        # print("A fake comment and real comment file has been saved. You may continue.\n")
...
save_files()
print("A fake comment and real comment file has been saved.\n")
